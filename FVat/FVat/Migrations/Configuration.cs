namespace FVat.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<FVat.DAL.AppDBContext>
    {
        ...
        private void AddTestVATs(DAL.AppDBContext context)
        {
            ...
            var testVAT1 = new Models.VAT() { Name = "Test Vat 1", PlaceOfIssue = "Warszawa", IssuerId = entities[0].Id, ReceiverId = entities[1].Id, DateOfIssue = DateTime.Now, DateOfService = DateTime.Now, PaymentMethod = Models.PaymentMethod.Online, DeliveryMethod = Models.DeliveryMethod.Courier };
